...
const QuranAudioTafsirFavoritesList = (props) => {
	const { data } = props;
	const { quranAudioTafsirFavorites } = useSelector(
					...
					>
						...
						>
							<TouchableOpacity
								...
								/* onPress={
									quranAudioTafsirFavorites.includes(item)
										? () =>
												dispatch(
...
export default QuranAudioTafsirFavoritesList;
